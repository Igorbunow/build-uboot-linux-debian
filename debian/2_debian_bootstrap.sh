...
VERSION=stable
BUILD_DIR=./root
PACKAGES="cloud-guest-utils kmod file mtd-utils openssh-server vim mc ethtool bind9-dnsutils isc-dhcp-client xxd htop net-tools logrotate btrfs-progs e2fsprogs exfatprogs util-linux fdisk u-boot-tools parted fdisk nfs-common ftp-ssl ftp usbutils lsof lsscsi lshw pciutils i2c-tools spi-tools iptables gpiod"
